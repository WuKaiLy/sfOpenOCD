...
#define APM32_FLASH_ACR_B0     0x40011000
#define APM32_FLASH_KEYR_B0    0x40011004
#define APM32_FLASH_OPTKEYR_B0 0x40011008
#define APM32_FLASH_SR_B0      0x4001100C
#define APM32_FLASH_CR_B0      0x40011010
#define APM32_FLASH_AR_B0      0x40011014
#define APM32_FLASH_OBR_B0     0x4001101C
#define APM32_FLASH_WRPR_B0    0x40011020
...
#define FLASH_OBL_LAUNCH	(1 << 13)	/* except apm32f003 series */
...
static int apm32x_get_property_addr(struct target *target, struct apm32x_property_addr *addr)
{
	...
	case CORTEX_M0_PARTNO: /* APM32F003 devices */
