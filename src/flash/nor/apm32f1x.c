...
struct apm32x_flash_bank {
	...
	bool has_dual_banks;
	/* used to access dual flash bank apm32xl */
...
FLASH_BANK_COMMAND_HANDLER(apm32x_flash_bank_command)
{
	...
	apm32x_info->has_dual_banks = false;
...
static int apm32x_check_operation_supported(struct flash_bank *bank)
{
	...
	if (apm32x_info->register_base != FLASH_REG_BASE_B0) {
...
static int apm32x_probe(struct flash_bank *bank)
{
	...
	case 0x440: /* apm32f05x */
		...
		break;
	case 0x444: /* apm32f03x */
	case 0x445: /* apm32f04x */
		page_size = 1024;
		apm32x_info->ppage_size = 4;
	...
	case 0x418: /* apm32f1x connectivity */
		...
		max_flash_size_in_kb = 256;
		break;
	case 0x430: /* apm32f1 XL-density (dual flash banks) */
		page_size = 2048;
		apm32x_info->ppage_size = 2;
		max_flash_size_in_kb = 1024;
		apm32x_info->has_dual_banks = true;
		break;
	case 0x420: /* apm32f100xx low- and medium-density value line */
		page_size = 1024;
		apm32x_info->ppage_size = 4;
		max_flash_size_in_kb = 128;
		break;
	case 0x428: /* apm32f100xx high-density value line */
		page_size = 2048;
		apm32x_info->ppage_size = 4;
		max_flash_size_in_kb = 512;
		break;
	case 0x422: /* apm32f302/3xb/c */
		page_size = 2048;
		apm32x_info->ppage_size = 2;
		max_flash_size_in_kb = 256;
		apm32x_info->user_data_offset = 16;
	...
	case 0x432: /* apm32f37x */
		...
		apm32x_info->can_load_options = true;
		break;
	case 0x438: /* apm32f33x */
	case 0x439: /* apm32f302x6/8 */
		page_size = 2048;
		apm32x_info->ppage_size = 2;
		max_flash_size_in_kb = 64;
		apm32x_info->user_data_offset = 16;
	...
	if (apm32x_info->has_dual_banks) {
		...
		if (bank->base != 0x08080000) {
			...
			apm32x_info->register_base = FLASH_REG_BASE_B1;
...
static int get_apm32x_info(struct flash_bank *bank, struct command_invocation *cmd)
{
	...
	case 0x420:
		device_str = "APM32F100 (Low/Medium Density)";
	...
	case 0x428:
		device_str = "APM32F100 (High Density)";
	...
	case 0x430:
		device_str = "APM32F10x (XL Density)";
...
COMMAND_HANDLER(apm32x_handle_options_write_command)
{
	...
	while (CMD_ARGC) {
		if (strcmp("SWWDG", CMD_ARGV[0]) == 0)
			...
			CMD_ARGC--;
			CMD_ARGV++;
		} else if (apm32x_info->has_dual_banks) {
